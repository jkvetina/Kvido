...
--
COMMENT ON COLUMN debug_log.context_a        IS 'Your APP context; use more descriptive name';
COMMENT ON COLUMN debug_log.context_b        IS 'Your APP context';
COMMENT ON COLUMN debug_log.context_c        IS 'Your APP context';
--
