...
CREATE TABLE debug_log_setup (
    ...
    --
    CONSTRAINT pk_debug_log_setup PRIMARY KEY (app_id, user_id, module_name, flag),
    --
...
--
COMMENT ON COLUMN debug_log_setup.app_id         IS 'App ID; 0 for no APEX, -1 for any app';
